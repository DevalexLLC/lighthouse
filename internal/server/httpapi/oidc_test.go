...
func enabledSettings() *store.OIDCSettings {
	return &store.OIDCSettings{
		Enabled: true, Issuer: "https://idp.example/realms/x", ClientID: "lighthouse",
		...
		RoleClaim: "groups", AdminValues: []string{"lighthouse-admins"},
...
func oidcSettingsBody() map[string]any {
	return map[string]any{
		...
		"client_id": "lighthouse", "client_secret": "",
