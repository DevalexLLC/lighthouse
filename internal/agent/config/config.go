// Package config loads and validates the lighthouse-agent configuration.
...
import (
	...
	"github.com/devalexllc/lighthouse/internal/strictyaml"
)
...
type Server struct {
	...
	// host (the proxy routes agents by SNI, e.g. grpc.lighthouse.example).
	SNI string `yaml:"sni"`
}
...
func Defaults() Config {
	return Config{
		StateDir: "/var/lib/lighthouse-agent",
		Spool: Spool{
