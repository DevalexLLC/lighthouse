...
// lighthouse-server (web/embed.go), so React et al. are redistributed inside
...
const out = [
  'Lighthouse dashboard — bundled third-party licenses',
  '===================================================',
  '',
  ...
  'lighthouse-server binary: the runtime dependencies, plus the build tools',
